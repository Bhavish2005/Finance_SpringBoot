...
// import { MdNotificationsActive, MdClose, MdAutoFixHigh, MdContentCopy, MdCheck, MdTrendingUp, MdLocalOffer, MdTrendingDown } from 'react-icons/md';
...
//         <button
//           onClick={handleOpenBubble} // <-- 3. Trigger the new handler here
...
//           {/* 4. Dynamic Notification Badge Counter (Only show if > 0) */}
//           {unreadCount > 0 && (
