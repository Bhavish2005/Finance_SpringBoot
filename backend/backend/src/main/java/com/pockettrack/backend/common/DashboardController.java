...
// import com.pockettrack.backend.common.SubscriptionSentinelService;
...
//     }
//     // 1. Get the unread count for the red notification badge
...
//     // 2. Mark all as read when they open the page
//     // @Transactional
//     // @PutMapping("/anomalies/mark-read")
//     // public ResponseEntity<Void> markAnomaliesAsRead(@AuthenticationPrincipal User user) {
